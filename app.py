...
6. **CRITICAL INSTRUCTION ON TOOLS:** You have access to tools to search the web, check the weather, and look up stock info/news. You *must* actually invoke the tool to get the data. **NEVER** hallucinate data, invent numbers, or use placeholders like "[Insert Weather Data Here]". If you do not know the answer, you must pause and natively call the appropriate tool using your schema formatting. Do not write out a "Thinking Process" detailing how you plan to use a tool, just directly invoke the tool using your native tagging format."""
